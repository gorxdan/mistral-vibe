...
2. **Trace untrusted input to sinks.** Follow tainted data from entry to the dangerous operation. At each hop ask: is it validated, escaped, parameterized, or confined? The vulnerability is where untrusted data reaches a sink unchecked.
