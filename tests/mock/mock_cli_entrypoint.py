"""CLI-mode twin of mock_entrypoint: patch LLM backends from
VIBE_MOCK_LLM_DATA, then run the real `vibe` CLI entrypoint (full startup,
worktree handling, tool execution) for subprocess e2e tests.
"""
