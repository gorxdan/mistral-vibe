...
class TestFindGitRepoAncestor:
    ...
    def test_ignores_stray_git_file_without_gitdir(self, tmp_path: Path) -> None:
        # F3: a plain file named .git that is not a valid "gitdir:" pointer must
        # not be mistaken for a repo root.
